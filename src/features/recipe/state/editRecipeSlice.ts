...
const editRecipeSlice = createSlice({
    ...
    reducers: {
        ...
        addPrefermentIngredient: (state, action: PayloadAction<{ id: string, newIngredient: Ingredient}>) => {
            ...
            state.preferments!.find((preferment: Preferment) => preferment.id === id)!.formula.ingredients.push(newIngredient);
...
export const {
    ...
    updateProcessMix,
    setEditRecipe,
    addPrefermentIngredient,
    addPreferment,
    removePreferment,
    removePrefermentIngredient,
    updatePrefermentIngredientRatio,
    updatePrefermentFlourName,
    updatePrefermentIngredientName,
