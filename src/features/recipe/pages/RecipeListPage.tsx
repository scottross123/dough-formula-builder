import {useGetRecipeQuery, useGetRecipesQuery, useGetRecipesTagsQuery} from "../../../api/recipesApi";
...
type RecipePreview = Readonly<Pick<Recipe, 'id' | 'title' | 'author' | 'tags'>>;
            ...
            <div className="grid grid-cols-1 gap-8 w-full">
                {
                    recipes?.map((recipe: Recipe) => {
                        const { id, title, author, tags }: RecipePreview = recipe;
